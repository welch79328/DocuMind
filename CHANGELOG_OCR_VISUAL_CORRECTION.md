...
實現了 LLM 文字校正功能，使用 AI 智能校正 OCR 錯誤，準確率提升 5-15%。同時優化了驗證界面，改為統一文字框顯示所有頁面結果。
...
| 原始 OCR | 65-70% | $0 | ~5 秒 |
| 規則後處理 | 67-72% | $0 | ~5 秒 |
| LLM LLM 文字校正 | 80-87% | $0.06-0.09 | ~25 秒 |
